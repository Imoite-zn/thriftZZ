...
class ZTextTheme {
  ...
  static TextTheme lightTextTheme =TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w400, color: Colors.black),

    bodyLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme darkTextTheme =TextTheme(
     ...
     bodyLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.white),
     bodyMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.white),
